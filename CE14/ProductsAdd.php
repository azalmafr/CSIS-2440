<?php
/*
 * UsersAdd.php used to include all required files for connecting to host, creating, dropping and/or recreating schema/database and table, inserting 
...
include 'index.php';         /* commented out until you want to drop and recreate the schema/database (dropping schema/db will drop all tables in schema/db)*/
...
//include 'insertTable.sql';        /* display existing database schemas */
//include 'queryResult.php';           /* commented out until you want to drop and recreate the table */
//include 'sql_insert.php';        /* comment out after table is created or uncomment to recreate the table */
//include 'tblproduct.sql';        /* display table layout */
//include 'dbcontroller.php';        /* array of table entries layout */
